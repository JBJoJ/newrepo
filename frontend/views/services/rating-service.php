            ...
            <div class="form">
                <div class="form-row">
                    <table style="width: 100%; border-collapse: collapse; border: 1px solid #ccc; background-color: #fff;">
                        <tr>
                            <th colspan="2" style="text-align: left; padding: 10px; background-color: #fff; border-bottom: 1px solid #ccc;">
                                A. Please check-mark the box that corresponds to your answer and provide the name/names of the service provider.
                            </th>
                        </tr>
                        <tr>
                            <td style="width: 50%; vertical-align: top; padding: 20px;">
                                <strong>SERVICE REQUESTED:</strong><br>
                                <ul style="list-style-type: none; padding-left: 20px; margin-top: 10px;"><br>
                                    <li><strong>Driving</strong></li><br>
                                    <li><strong>Janitorial</strong></li><br>
                                    <li><strong>Vehicle/Equipment Maintenance</strong></li>
                                </ul>
                            </td>
                            <td style="width: 50%; vertical-align: top; padding: 20px;">
                                <strong>Name/Names of Service Provider:</strong><br><br>
                                <?= $form->field($model, 'driving')->textInput(['maxlength' => true, 'style' => 'border: 1px solid #ccc; width: 100%; padding: 10px; margin-bottom: 10px;'])->label(false) ?>
                                <?= $form->field($model, 'janitorial')->textInput(['maxlength' => true, 'style' => 'border: 1px solid #ccc; width: 100%; padding: 10px; margin-bottom: 10px;'])->label(false) ?>
                                <?= $form->field($model, 'equipment')->textInput(['maxlength' => true, 'style' => 'border: 1px solid #ccc; width: 100%; padding: 10px; margin-bottom: 10px;'])->label(false) ?>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <table>
                    ...
                    <tr>
                        <td>a. Knowledgeable and up-to-date (mindful, well informed, trained, etc.)</td>
                        <?php
                    ...
                    <tr>
                        <td>b. Professional attitude and appearance (strong ethics, emotional control, etc.)</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                    ...
                    <tr>
                        <td>c. Good judgement (listens, respectful, considerate, communicate clearly and effectively, etc.)</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                    ...
                    <tr>
                        <td>d. Timeliness of service (prompt, quick to respond, no hesitation/delay)</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                    ...
                    <tr>
                        <td>a.  Well maintained facility/vehicle (condition, operating smoothly infrastructure/ equipment/assets, etc, less/no downtimes)</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                    ...
                    <tr>
                        <td>b.  Readiness and availability of facility/vehicle (organize and clean workplace/vehicle)</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                    ...
                    <tr>
                        <td>c. Comfort and Safety (no accident occurrences, healthy workplace/ environment)</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            foreach ($radioOptions as $value => $label) {
                                echo '<td style="text-align: center;">'; // Start a new <td> for each radio button
                                echo '<input type="radio" name="' . Html::getInputName($model, 'ro_a') . '" value="' . $value . '">'; // Render the radio button
                                echo '</td>'; // End the <td> for this radio button
                            }
                        ?>
                    </tr>
