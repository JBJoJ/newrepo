...
<table>
    <thead>
        <tr>
            ...
            <th colspan="4" style="background-color: #FFC000; color: white;">RESPONSIVENESS, ASSURANCE, INTEGRITY, AND COMMUNICATION</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <?php foreach ($very_satisfy as $result): ?>
                ...
                <td><?= $result['very_satisfy_ro_a'] ?></td>
            <?php endforeach; ?>
        ...
        <tr>
            ...
            <?php foreach ($very_dissatisfy as $result): ?>
                ...
                <td><?= $result['very_dissatisfy_ro_a'] ?></td>
            <?php endforeach; ?>
        ...
        <tr>
            ...
            <?php foreach ($no_response as $result): ?>
                <td><?= $result['no_response_raic_a'] ?></td>
                <td><?= $result['no_response_raic_b'] ?></td>
                <td><?= $result['no_response_raic_c'] ?></td>
                <td><?= $result['no_response_raic_d'] ?></td>
                <td><?= $result['no_response_af_a'] ?></td>
                <td><?= $result['no_response_af_b'] ?></td>
                <td><?= $result['no_response_af_c'] ?></td>
                <td><?= $result['no_response_ro_a'] ?></td>
            <?php endforeach; ?>
            <td></td>
        </tr>
        <tr>
            ...
            <?php foreach ($for_validation as $result): ?>
                ...
                <td><?= $result['for_validation_ro_a'] ?></td>
            <?php endforeach; ?>
            <td></td>
...
<div class="additional-container">
    ...
    <table>
        <thead>
            <tr>
                <th colspan="3" style="background-color: #9BBB59; color: white;">SERVICE REQUESTED</th>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            <tr class="left-align">
                <td>DRIVING</td>
                <td class="placeholder"><?= $requested['driving'] ?></td>
                <td class="placeholder"><?= $driving_percent ?>%</td>
            </tr>
            <tr class="left-align">
                <td>JANITORIAL</td>
                <td class="placeholder"><?= $requested['janitorial'] ?></td>
                <td class="placeholder"><?= $janitorial_percent ?>%</td>
            </tr>
            <tr class="left-align">
                <td>VEHICLE/EQUIPMENT MAINTENANCE</td>
                <td class="placeholder"><?= $requested['equipment'] ?></td>
                <td class="placeholder"><?= $equipment_percent ?>%</td>
            </tr>
            <tr class="left-align">
                <td style="background-color: #FFC000; color: white;">TOTAL</td>
                <td class="placeholder" style="background-color: #FFC000; color: black;"><?= $total_requested ?></td>
                <td class="placeholder" style="background-color: #FFC000; color: black;"><?= $service_percent ?>%</td>
            </tr>
        </tbody>
    </table>
