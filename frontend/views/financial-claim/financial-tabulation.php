...
<h2>Financial Claim - External Tabulation Sheet Summary</h2>

<!-- First Table: Tabulation Sheet Summary -->
<table>
    <thead>
        <tr>
            <th colspan="2">Proposed Formula</th>
            <th colspan="6">RESPONSIVENESS, ASSURANCE, INTEGRITY, AND COMMUNICATION</th>
            <th colspan="3">ACCESS AND FACILITIES</th>
            <th colspan="1">RELIABILITY AND OUTCOME</th>
            <th>OVERALL PMT</th>
        </tr>
        <tr>
            <th>Weights</th>
...
<style>
        ...
        .container {
            ...
            width: 70%; /* Set width to 70% of the parent element (body) */
        ...
        .additional-container {
            ...
            gap: 10px; /* Adjust gap between tables */
        ...
        .additional-container table {
            width: 35%; /* Adjust width of each table */
...
table th.csf-score1 td:nth-child(2){
    background-color: #002060;
    color: white;;
}
table th[colspan="6"] {
    background-color: #FFC000;
    color: white;; /* Responsiveness, Assurance, Integrity, and Communication */
}

table th[colspan="3"] {
    background-color: #FFC000;
    color: white; /* Access and Facilities */
}
table th[colspan="1"] {
    background-color: #FFC000;
    color: white; /* Choose any color you prefer */
}
table tr.total-responses td:nth-child(3),
table tr.total-responses td:nth-child(4),
table tr.total-responses td:nth-child(5),
table tr.total-responses td:nth-child(6),
table tr.total-responses td:nth-child(7),
table tr.total-responses td:nth-child(8),
table tr.total-responses td:nth-child(9),
table tr.total-responses td:nth-child(10),
table tr.total-responses td:nth-child(11),
table tr.total-responses td:nth-child(12) {
    background-color: #B6DDE8;
}
table tr.percent-satisfaction td:nth-child(3),
table tr.percent-satisfaction td:nth-child(4),
table tr.percent-satisfaction td:nth-child(5),
table tr.percent-satisfaction td:nth-child(6),
table tr.percent-satisfaction td:nth-child(7),
table tr.percent-satisfaction td:nth-child(8),
table tr.percent-satisfaction td:nth-child(9),
table tr.percent-satisfaction td:nth-child(10),
table tr.percent-satisfaction td:nth-child(11),
table tr.percent-satisfaction td:nth-child(12) {
    background-color: #B6DDE8;
}
table tr.csf-score td:nth-child(3),
table tr.csf-score td:nth-child(4),
table tr.csf-score td:nth-child(5),
table tr.csf-score td:nth-child(6),
table tr.csf-score td:nth-child(7),
table tr.csf-score td:nth-child(8),
table tr.csf-score td:nth-child(9),
table tr.csf-score td:nth-child(10),
table tr.csf-score td:nth-child(11),
table tr.csf-score td:nth-child(12) {
    background-color: #B6DDE8;
}
table tr.csf-rating td:nth-child(3),
table tr.csf-rating td:nth-child(4),
table tr.csf-rating td:nth-child(5),
table tr.csf-rating td:nth-child(6),
table tr.csf-rating td:nth-child(7),
table tr.csf-rating td:nth-child(8),
table tr.csf-rating td:nth-child(9),
table tr.csf-rating td:nth-child(10),
table tr.csf-rating td:nth-child(11),
table tr.csf-rating td:nth-child(12) {
    background-color: #B6DDE8;
}
table tr.level-satisfaction td:nth-child(3),
table tr.level-satisfaction td:nth-child(4),
table tr.level-satisfaction td:nth-child(5),
table tr.level-satisfaction td:nth-child(6),
table tr.level-satisfaction td:nth-child(7),
table tr.level-satisfaction td:nth-child(8),
table tr.level-satisfaction td:nth-child(9),
table tr.level-satisfaction td:nth-child(10),
table tr.level-satisfaction td:nth-child(11),
table tr.level-satisfaction td:nth-child(12) {
    background-color: #B6DDE8;
}
    </style>