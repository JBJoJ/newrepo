        ...
        <section>
            ...
            <div class="form">
                <table>
                    ...
                    <tr>
                        <td colspan="7"><strong>5. 	ADMINISTRATIVE ARRANGEMENTS</strong></td>
                    </tr>
                    <tr>
                        <td colspan="7"><strong>Dimensions Covered: Access and Facilities</strong></td>
                    </tr>
                    <tr>
                        <td>a. Conduciveness of venue</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                            ...
                            foreach ($radioOptions as $value => $label) {
                                echo '<td style="text-align: center;">'; // Start a new <td> for each radio button
                                echo '<input type="radio" name="' . Html::getInputName($model, 'admin_a') . '" value="' . $value . '">'; // Render the radio button
                                echo '</td>'; // End the <td> for this radio button
                            }
                        ?>
                    </tr>
                    <tr>
                        <td>b. Cleanliness and provision for sanitation</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                            ...
                            foreach ($radioOptions as $value => $label) {
                                echo '<td style="text-align: center;">'; // Start a new <td> for each radio button
                                echo '<input type="radio" name="' . Html::getInputName($model, 'admin_b') . '" value="' . $value . '">'; // Render the radio button
                                echo '</td>'; // End the <td> for this radio button
                            }
                        ?>
                    </tr>
                    <tr>
                        <td>c. Food quality</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                            ...
                            foreach ($radioOptions as $value => $label) {
                                echo '<td style="text-align: center;">'; // Start a new <td> for each radio button
                                echo '<input type="radio" name="' . Html::getInputName($model, 'admin_c') . '" value="' . $value . '">'; // Render the radio button
                                echo '</td>'; // End the <td> for this radio button
                            }
                        ?>
                    </tr>
                    <tr>
                        <td>d. Clarity of audio / sound system</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                            ...
                            foreach ($radioOptions as $value => $label) {
                                echo '<td style="text-align: center;">'; // Start a new <td> for each radio button
                                echo '<input type="radio" name="' . Html::getInputName($model, 'admin_d') . '" value="' . $value . '">'; // Render the radio button
                                echo '</td>'; // End the <td> for this radio button
                            }
                        ?>
                    </tr>
                    <tr>
                        <td>e. Presentation facilities (projector, screen, and laptop)</td>
                        <?php
                            $radioOptions = Rating::getRatingradio();
                            ...
                            foreach ($radioOptions as $value => $label) {
                                echo '<td style="text-align: center;">'; // Start a new <td> for each radio button
                                echo '<input type="radio" name="' . Html::getInputName($model, 'admin_e') . '" value="' . $value . '">'; // Render the radio button
                                echo '</td>'; // End the <td> for this radio button
                            }
                        ?>
                    </tr>
