...
<div class="table-container">
    <table>
        ...
        <thead>
            <tr>
                <th colspan="2" style="background-color: #002060; color: white; position: sticky;">Proposed Formula</th>
                ...
                <th colspan="3" style="background-color: #FFC000; color: white;">RESOURCE SPEAKER 1</th>
                <th colspan="3" style="background-color: #FFC000; color: white;">RESOURCE SPEAKER 2</th>
                <th colspan="3" style="background-color: #FFC000; color: white;">RESOURCE SPEAKER 3</th>
                <th colspan="4" style="background-color: #FFC000; color: white;">TRAINING HOST/SECRETARIAT</th>
                <th colspan="5" style="background-color: #FFC000; color: white;">ADMINISTRATIVE ARRANGEMENTS</th>
                <th>OVERALL PMT</th>
            </tr>
            <tr>
                <!-- Add your table headers here -->
                <th style="width: 5%; position: sticky;">Weights</th>
                <th style="width: 10%; position: sticky;">Level of Satisfaction</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $result['very_satisfy_admin_a'] ?></td>
                <td><?= $result['very_satisfy_admin_b'] ?></td>
                <td><?= $result['very_satisfy_admin_c'] ?></td>
                <td><?= $result['very_satisfy_admin_d'] ?></td>
                <td><?= $result['very_satisfy_admin_e'] ?></td>
                <?php endforeach; ?>
            ...
            <tr>
                ...
                <td><?= $result['satisfy_admin_a'] ?></td>
                <td><?= $result['satisfy_admin_b'] ?></td>
                <td><?= $result['satisfy_admin_c'] ?></td>
                <td><?= $result['satisfy_admin_d'] ?></td>
                <td><?= $result['satisfy_admin_e'] ?></td>
                <?php endforeach; ?>
            ...
            <tr>
                ...
                <td><?= $result['dissatisfy_admin_a'] ?></td>
                <td><?= $result['dissatisfy_admin_b'] ?></td>
                <td><?= $result['dissatisfy_admin_c'] ?></td>
                <td><?= $result['dissatisfy_admin_d'] ?></td>
                <td><?= $result['dissatisfy_admin_e'] ?></td>
                <?php endforeach; ?>
            ...
            <tr>
                ...
                <td><?= $result['very_dissatisfy_admin_a'] ?></td>
                <td><?= $result['very_dissatisfy_admin_b'] ?></td>
                <td><?= $result['very_dissatisfy_admin_c'] ?></td>
                <td><?= $result['very_dissatisfy_admin_d'] ?></td>
                <td><?= $result['very_dissatisfy_admin_e'] ?></td>
                <?php endforeach; ?>
            ...
            <tr>
                ...
                <td><?= $result['no_response_admin_a'] ?></td>
                <td><?= $result['no_response_admin_b'] ?></td>
                <td><?= $result['no_response_admin_c'] ?></td>
                <td><?= $result['no_response_admin_d'] ?></td>
                <td><?= $result['no_response_admin_e'] ?></td>
                <?php endforeach; ?>
                <td></td>
            </tr>
            <tr>
                ...
                <td><?= $result['for_validation_admin_a'] ?></td>
                <td><?= $result['for_validation_admin_b'] ?></td>
                <td><?= $result['for_validation_admin_c'] ?></td>
                <td><?= $result['for_validation_admin_d'] ?></td>
                <td><?= $result['for_validation_admin_e'] ?></td>
                <?php endforeach; ?>
                <td></td>
            </tr>
            ...
            <tr class="percent-satisfaction">
                ...
                <td style="background-color: #B6DDE8; color: black;"><?= $satisfaction['admin_a'] ?>%</td>
                <td style="background-color: #B6DDE8; color: black;"><?= $satisfaction['admin_b'] ?>%</td>
                <td style="background-color: #B6DDE8; color: black;"><?= $satisfaction['admin_c'] ?>%</td>
                <td style="background-color: #B6DDE8; color: black;"><?= $satisfaction['admin_d'] ?>%</td>
                <td style="background-color: #B6DDE8; color: black;"><?= $satisfaction['admin_e'] ?>%</td>
                <td></td>
            </tr>
            ...
            <tr class="csf-score">
                ...
                <td style="background-color: #B6DDE8; color: black;"><?= $score['admin_a'] ?></td>
                <td style="background-color: #B6DDE8; color: black;"><?= $score['admin_b'] ?></td>
                <td style="background-color: #B6DDE8; color: black;"><?= $score['admin_c'] ?></td>
                <td style="background-color: #B6DDE8; color: black;"><?= $score['admin_d'] ?></td>
                <td style="background-color: #B6DDE8; color: black;"><?= $score['admin_e'] ?></td>
                <td></td>
            </tr>
            <tr class="csf-rating">
                <td></td>
                ...
                <td style="background-color: #B6DDE8; color: black;"><?= $ratings['admin_a'] ?>%</td>
                <td style="background-color: #B6DDE8; color: black;"><?= $ratings['admin_b'] ?>%</td>
                <td style="background-color: #B6DDE8; color: black;"><?= $ratings['admin_c'] ?>%</td>
                <td style="background-color: #B6DDE8; color: black;"><?= $ratings['admin_d'] ?>%</td>
                <td style="background-color: #B6DDE8; color: black;"><?= $ratings['admin_e'] ?>%</td>
                <td></td>
            </tr>
            <tr class="level-satisfaction">
                ...
                <td style="background-color: #B6DDE8; color: black;"><?= satisfaction($ratings['admin_a']) ?></td>
                <td style="background-color: #B6DDE8; color: black;"><?= satisfaction($ratings['admin_b']) ?></td>
                <td style="background-color: #B6DDE8; color: black;"><?= satisfaction($ratings['admin_c']) ?></td>
                <td style="background-color: #B6DDE8; color: black;"><?= satisfaction($ratings['admin_d']) ?></td>
                <td style="background-color: #B6DDE8; color: black;"><?= satisfaction($ratings['admin_e']) ?></td>
                <td></td>
            </tr>
        </tbody>
    </table>
...
<div class="container">
    ...
    <table class="arta-table">
        ...
        <tbody>
            ...
            <tr class="left-align">
                <td>HOST/SECRETARIAT</td>
                <td class="placeholder"><?= $host_score ?></td>
            </tr>
            <tr class="left-align">
                <td style="background-color: #002060; color: white;">OVERALL AVE</td>
