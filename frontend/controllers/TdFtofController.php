...
/**
 * TdFtofController implements the CRUD actions for TdFtof model.
 */
class TdFtofController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Displays a single TdFtof model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Updates an existing TdFtof model.
    ...
    /**
     * Deletes an existing TdFtof model.
    ...
    /**
     * Finds the TdFtof model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return TdFtof the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TdFtof::findOne(['id' => $id])) !== null) {
            return $model;
        }
    ...
    public function actionTrainingFtof($process_id)
    {
        $model = new TdFtof();
        ...
        return $this->renderPartial('training-ftof', [
            'model' => $model,
            'commentsmodel' => $commentsmodel,
        ]);
    }

    public function actionTrainingFtofTabulation()
    {
        ...
        ->select([
            ...
            'very_satisfy_admin_a' => 'SUM(CASE WHEN admin_a = 1 THEN 1 ELSE 0 END)',
            'very_satisfy_admin_b' => 'SUM(CASE WHEN admin_b = 1 THEN 1 ELSE 0 END)',
            'very_satisfy_admin_c' => 'SUM(CASE WHEN admin_c = 1 THEN 1 ELSE 0 END)',
            'very_satisfy_admin_d' => 'SUM(CASE WHEN admin_d = 1 THEN 1 ELSE 0 END)',
            'very_satisfy_admin_e' => 'SUM(CASE WHEN admin_e = 1 THEN 1 ELSE 0 END)',
        ])
        ->from('td_ftof')
        ->all();
        //END
        ...
        ->select([
            ...
            'satisfy_admin_a' => 'SUM(CASE WHEN admin_a = 2 THEN 1 ELSE 0 END)',
            'satisfy_admin_b' => 'SUM(CASE WHEN admin_b = 2 THEN 1 ELSE 0 END)',
            'satisfy_admin_c' => 'SUM(CASE WHEN admin_c = 2 THEN 1 ELSE 0 END)',
            'satisfy_admin_d' => 'SUM(CASE WHEN admin_d = 2 THEN 1 ELSE 0 END)',
            'satisfy_admin_e' => 'SUM(CASE WHEN admin_e = 2 THEN 1 ELSE 0 END)',
        ])
        ->from('td_ftof')
        ->all();
        //END
      ...
      //To get the count of each cell of the row in Dissatisfied
        ...
        ->select([
            ...
            'dissatisfy_admin_a' => 'SUM(CASE WHEN admin_a = 3 THEN 1 ELSE 0 END)',
            'dissatisfy_admin_b' => 'SUM(CASE WHEN admin_b = 3 THEN 1 ELSE 0 END)',
            'dissatisfy_admin_c' => 'SUM(CASE WHEN admin_c = 3 THEN 1 ELSE 0 END)',
            'dissatisfy_admin_d' => 'SUM(CASE WHEN admin_d = 3 THEN 1 ELSE 0 END)',
            'dissatisfy_admin_e' => 'SUM(CASE WHEN admin_e = 3 THEN 1 ELSE 0 END)',
        ])
        ->from('td_ftof')
        ->all();
        //END
        ...
        ->select([
            ...
            'very_dissatisfy_admin_a' => 'SUM(CASE WHEN admin_a = 4 THEN 1 ELSE 0 END)',
            'very_dissatisfy_admin_b' => 'SUM(CASE WHEN admin_b = 4 THEN 1 ELSE 0 END)',
            'very_dissatisfy_admin_c' => 'SUM(CASE WHEN admin_c = 4 THEN 1 ELSE 0 END)',
            'very_dissatisfy_admin_d' => 'SUM(CASE WHEN admin_d = 4 THEN 1 ELSE 0 END)',
            'very_dissatisfy_admin_e' => 'SUM(CASE WHEN admin_e = 4 THEN 1 ELSE 0 END)',
        ])
        ->from('td_ftof')
        ->all();
        //END
        ...
        ->select([
            ...
            'no_response_admin_a' => 'SUM(CASE WHEN admin_a = 5 THEN 1 ELSE 0 END)',
            'no_response_admin_b' => 'SUM(CASE WHEN admin_b = 5 THEN 1 ELSE 0 END)',
            'no_response_admin_c' => 'SUM(CASE WHEN admin_c = 5 THEN 1 ELSE 0 END)',
            'no_response_admin_d' => 'SUM(CASE WHEN admin_d = 5 THEN 1 ELSE 0 END)',
            'no_response_admin_e' => 'SUM(CASE WHEN admin_e = 5 THEN 1 ELSE 0 END)',
        ])
        ->from('td_ftof')
        ->all();
        //END
        ...
        ->select([
            ...
            'for_validation_admin_a' => 'SUM(CASE WHEN admin_a = 6 THEN 1 ELSE 0 END)',
            'for_validation_admin_b' => 'SUM(CASE WHEN admin_b = 6 THEN 1 ELSE 0 END)',
            'for_validation_admin_c' => 'SUM(CASE WHEN admin_c = 6 THEN 1 ELSE 0 END)',
            'for_validation_admin_d' => 'SUM(CASE WHEN admin_d = 6 THEN 1 ELSE 0 END)',
            'for_validation_admin_e' => 'SUM(CASE WHEN admin_e = 6 THEN 1 ELSE 0 END)',
        ])
        ->from('td_ftof')
        ->all();
        //END
        ...
        $columns = [
            ...
            'rs1_a', 'rs1_b', 'rs1_c', 'rs2_a', 'rs2_b', 'rs2_c',
            'rs3_a', 'rs3_b', 'rs3_c', 'trn_host_a', 'trn_host_b', 'trn_host_c',
            'trn_host_d', 'admin_a', 'admin_b', 'admin_c', 'admin_d', 'admin_e'
        ...
        $realibility = round(($score['ocd_b'] + $methodology_score + $score['rs1_b'] + $score['trn_host_b']) / 8, 2);
        ...
        $realibility_satisfaction = round(($satisfaction['ocd_b'] + $methodology_satisfaction + $satisfaction['rs1_b'] + $satisfaction['trn_host_b']) / 7, 2);
        ...
        $access_facilities_satisfaction = round(($satisfaction['admin_a'] + $satisfaction['admin_b'] + $satisfaction['admin_c'] + $satisfaction['admin_d'] + $satisfaction['admin_e']) / 5, 2);
        ...
        $host_score = $score['admin_a'];

        $overall_ave_score = round(($ocd_score + $methodology_score + $rs_score + $moderator_score + $host_score) / 5, 2);
        ...
        return $this->renderPartial('training-ftof-tabulation', [
